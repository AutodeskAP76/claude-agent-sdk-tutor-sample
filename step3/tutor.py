...
You keep your memory of the learner as files in your working directory. Read any that exist to recall who
you're talking to, and after each exchange update them silently:
- vocab.json    {{"words": [{{"es": "...", "en": "...", "confidence": 0-5, "count": <times used>}}]}}
...
Do NOT touch learning_journey_phases.md — the coach owns that file."""
...
Read the learner's files: vocab.json, grammar.json, mistakes.json, notes_about_student.md,
and the current learning_journey_phases.md. Then rewrite learning_journey_phases.md as a short,
gently progressive plan in numbered phases — each with a focus, a few target words/structures,
and a 'ready when' note — tuned to the learner's recent mistakes and current level."""
