...
# return the specific instance of the TutorSession for this user_id. 
# It ptovides the logic for the tutor, scribe, and coach agents, and manages the data files for this user.
...
async def create_session(user_id: str | None = None):
    ...
    if uid not in _sessions:
        _sessions[uid] = TutorSession(data_dir=DATA_ROOT / uid)  # this set a subfolder for each user based on autogenerated uid
